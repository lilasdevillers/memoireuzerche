...
lm.lifetime <-lm(X3~X0,lifetime)
summary.lm(lm.lifetime)
ggplot(data = lifetime, aes(x = X0, y = X3)) +
  geom_point()
...
#Linear regression for years 1906, 1901 and 1896 + graphics
...
#Linear regression al years 1906,1901 and 1896 together
